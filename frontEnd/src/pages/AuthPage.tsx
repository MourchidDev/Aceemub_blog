...
export default function AuthPage({ mode }: { mode: AuthMode }) {
  ...
  return (
    <main className="min-h-screen bg-aemb-cream pt-28 pb-16 px-6">
      <section className="max-w-md mx-auto bg-white border border-emerald-900/10 shadow-xl shadow-emerald-900/5 rounded-lg p-6 sm:p-8">
        <div className="mb-8">
          <p className="text-sm font-semibold text-aemb-gold">ACEEMUB Benin</p>
          <h1 className="font-serif text-3xl font-bold text-aemb-green mt-2">{title}</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {isRegister && (
            <label className="block">
              ...
              <span className="mt-1 flex items-center gap-3 rounded-md border border-gray-200 bg-white px-3 py-2.5 focus-within:border-aemb-green">
          ...
          <label className="block">
            ...
            <span className="mt-1 flex items-center gap-3 rounded-md border border-gray-200 bg-white px-3 py-2.5 focus-within:border-aemb-green">
              ...
              <button
                ...
                className="text-gray-400 hover:text-aemb-green"
          ...
          <button
            ...
            className="w-full rounded-md bg-aemb-green px-4 py-3 font-semibold text-white transition hover:bg-emerald-800 disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link
            ...
            className="font-semibold text-aemb-green hover:text-aemb-gold"
          >
